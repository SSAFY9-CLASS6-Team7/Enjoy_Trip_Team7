  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "create",
        name: "boardcreate",
        component: () => import(/* webpackChunkName: "board" */ "../components/board/BoardCreate.vue"),
      },
      {
        path: "update",
        name: "boardupdate",
        component: () => import(/* webpackChunkName: "board" */ "../components/board/BoardUpdate.vue"),
      },
      {
        path: "view/:boardId",
        name: "boardview",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "empty",
        name: "historyempty",
        component: () => import(/* webpackChunkName: "history" */ '@/components/history/HistoryEmpty.vue'),
      },
      {
        path: "image",
        name: "historyimage",
        component: () => import(/* webpackChunkName: "history" */ '@/components/history/HistoryImage.vue'),
      },
      {
        path: "update",
        name: "historyupdate",
    ...
    children: [
      {
        path: "list",
        name: "attractionlist",
        component: () => import(/* webpackChunkName: "user" */ '@/components/attraction/AttractionList.vue'),
      },
      {
        path: "view",
        name: "attractionview",
        component: () => import(/* webpackChunkName: "user" */ '@/components/attraction/AttractionView.vue'),
      }, 
    ],
  },
]
