  ...
  <div class="container">
    ...
    <div class="main">
      ...
      <div class="attraction-detail">
        ...
        <div class="overview-container">
          <div class="image-container">
            <img
              v-if="this.attraction.thumbnail != ''"
              :src="this.attraction.thumbnail"
              class="thumbnail"
            />
          </div>
          <div class="overview">
            <div class="inner-title" style="color: #e93f78; font-weight: 900; margin: 0 0 10px 0">
              소개
            </div>
      ...
      <div class="map-container">
        <div class="inner-title" style="color: #e93f78; font-weight: 900; margin: 0 0 10px 0">
          <img src="@/assets/attraction_icon/address.svg" class="marker" /> 위치
        </div>
...
export default {
  ...
  created() {
    axios
      .get(process.env.VUE_APP_MY_BASE_URL + '/attraction/' + this.$route.params.attractionId)
      .then((response) => {
