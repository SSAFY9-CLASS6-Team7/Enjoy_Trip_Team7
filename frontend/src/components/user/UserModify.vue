  ...
  <div class="container">
    ...
    <div class="main">
      <div class="profile-image-container">
        ...
        <div class="user-name">{{ this.checkUserInfo.name }} 님</div>
      </div>
      ...
      <div class="password-container">
        ...
        >
          ...
          />
          <img
            v-if="passwordFlag === false"
            src="@/assets/user_icons/fail.svg"
            class="status-icon"
          />
        </div>
      </div>
        ...
        <div class="gender-input-container">
          <div class="male-container">
            <input
              ...
              hidden
            />
            <label class="gender-radio" for="M" :class="{ 'male-selected': gender == 'M' }"
              >남 자</label
            >
          </div>
          <div class="female-container">
            <input
              ...
              hidden
            />
            <label class="gender-radio" for="F" :class="{ 'female-selected': gender == 'F' }"
              >여 자</label
            >
          </div>
        </div>
